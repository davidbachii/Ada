...
with Ada.Numerics.Elementary_Functions; -- Incluimos el paquete de funciones matemáticas
use Ada.Numerics.Elementary_Functions; -- Usamos el paquete de funciones matemáticas
...
-- Definimos dentro del procedimiento principal procedimientos que vamos a poder usar en el programa principal
begin   
    set_col(5);
